...
REM
REM Generated by Vivado on Tue Dec 20 16:43:37 +0800 2022
...
echo "xvlog --incr --relax -prj t_HW3_FP_subtractor_vlog.prj"
call xvlog  --incr --relax -prj t_HW3_FP_subtractor_vlog.prj -log xvlog.log
