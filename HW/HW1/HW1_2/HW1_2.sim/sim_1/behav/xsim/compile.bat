...
REM
REM Generated by Vivado on Wed Oct 19 00:53:03 +0800 2022
...
echo "xvlog --incr --relax -prj t_HW1_delay_vlog.prj"
call xvlog  --incr --relax -prj t_HW1_delay_vlog.prj -log xvlog.log
