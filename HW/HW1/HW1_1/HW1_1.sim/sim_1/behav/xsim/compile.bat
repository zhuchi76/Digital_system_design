...
REM
REM Generated by Vivado on Sun Oct 16 20:56:16 +0800 2022
...
echo "xvlog --incr --relax -prj t_HW1_comb_vlog.prj"
call xvlog  --incr --relax -prj t_HW1_comb_vlog.prj -log xvlog.log
